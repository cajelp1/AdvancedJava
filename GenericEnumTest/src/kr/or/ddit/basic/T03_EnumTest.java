...
public class T03_EnumTest {
	...
	// 데이터값을 정해줄 경우에는 생성자를 만들어서 괄호 속의 값이 변수에 저장되도록 해야한다.
	...
	/*
		...
		3. valueOf("열거형상수이름"); 저장된 열거형에서 '열거형상수이름'과 일치하는 열거형 상수를 반환한다.
		
	 */
		
		City myCity1; // 열거형 객체의 변수 선언
		City myCity2;
		
		//열거형 객체변수에 값 저장하기
		myCity2 = City.서울;
		myCity1 = City.valueOf("서울"); //City enum에서 '서울'인 객체 반환
		
		//City myCity1 = City.valueOf("서울");
		//City myCity2 = City.서울;
		...
		//열거형이름.values() : 데이터를 배열로 가져온다. 리턴타입이 배열이다!
		...
		for(City city : City.values()) { // 오 향상된 for문을 이렇게 쓰네!
