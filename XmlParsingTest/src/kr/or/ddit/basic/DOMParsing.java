...
public class DOMParsing {
	...
	public void parse() {
		...
		try {
			...
			// 속성 접근방법2 : 노드객체의 getAttribute() 메서드 이용(속성노드 접근)
			NamedNodeMap nodeMap = firstBookNode.getAttributes();
			System.out.println("노드객체의 getAttributes() 메서드이용 : " 
